...
class TestInputValidatorSecurity:
    ...
    def test_dos_json_depth_recursion_stack_overflow(self):
        ...
        assert elapsed < 1.0, "JSON depth validation should complete quickly (no stack overflow)"
    ...
    def test_redos_regex_pattern_matching(self):
        ...
        for test_input in test_cases:
            ...
            assert elapsed < 1.0, f"Pattern matching should complete quickly (ReDoS protection), took {elapsed}s for input length {len(test_input)}"
    ...
    def test_null_byte_injection(self):
        ...
        for test_id in null_byte_tests:
            ...
            assert not is_valid, f"Should reject webhook ID with null bytes: {repr(test_id)}"
    ...
    def test_webhook_id_path_traversal_bypass(self):
        ...
        for test_id in path_traversal_attempts:
            ...
            assert not is_valid, f"Should reject path traversal in webhook ID: {test_id}"
