...
class TestAWSSQSQueueInjection:
    ...
    async def test_queue_url_valid_aws_format(self):
        ...
        for valid_url in valid_urls:
            ...
            try:
                ...
                assert False, f"Should accept valid AWS SQS URL: {valid_url}, error: {e}"
    ...
    async def test_queue_name_valid_format(self):
        ...
        for valid_name in valid_names:
            ...
            try:
                ...
                assert False, f"Should accept valid queue name: {valid_name}, error: {e}"
    ...
    async def test_queue_name_too_long(self):
        ...
        config = {
            "module": "aws_sqs",
            "module-config": {
                "queue_name": "a" * 81  # Exceeds 80 char limit
            },
            "connection_details": {
                "region_name": "us-east-1"
            }
    ...
    async def test_region_name_injection_attempts(self):
        ...
        for malicious_region in injection_attempts:
            ...
            try:
                ...
                assert ("region" in error_msg or "invalid" in error_msg or "sqs" in error_msg or 
                       "aws" in error_msg or "error" in error_msg or "processing" in error_msg), \
        ...
        for valid_region in valid_regions:
            ...
            try:
                ...
                if "region" in str(e).lower():
                    assert False, f"Should accept valid region: {valid_region}, error: {e}"
    ...
    async def test_region_name_type_validation(self):
        ...
        for invalid_type in invalid_types:
            ...
            try:
                ...
                # Expected - validation should reject (may be sanitized as generic Exception)
                error_msg = str(e).lower()
                assert "region" in error_msg or "invalid" in error_msg or "sqs" in error_msg or "aws" in error_msg or "error" in error_msg or "string" in error_msg
...
class TestAWSSQSMessageAttributeInjection:
    ...
    async def test_message_attribute_key_injection(self):
        ...
        mock_client.get_queue_url.return_value = {'QueueUrl': 'https://sqs.us-east-1.amazonaws.com/123456789012/MyQueue'}
        ...
        for malicious_key in malicious_keys:
            ...
            try:
                ...
                assert mock_client.send_message.called or mock_client.get_queue_url.called
            except Exception as e:
                # Should not crash
                error_msg = str(e).lower()
        ...
        with patch('asyncio.get_event_loop') as mock_loop:
            ...
            if call_args_capture:
                ...
                if message_attributes is None:
                    ...
                    attr_value = message_attributes.get("X-Header", {}).get("StringValue", "")
                    assert len(attr_value) <= 256, f"Attribute value should be <= 256 chars, got {len(attr_value)}"
                else:
    ...
    async def test_large_payload_dos(self):
        ...
        with patch('asyncio.get_event_loop') as mock_loop:
            ...
            try:
                ...
                error_msg = str(e).lower()
                assert "sqs" in error_msg or "aws" in error_msg or "message" in error_msg or "size" in error_msg
...
class TestAWSSQSErrorDisclosure:
    ...
    async def test_aws_error_sanitization(self):
        ...
        mock_client.get_queue_url.side_effect = ClientError(error_response, 'GetQueueUrl')
        module.sqs_client = mock_client
        ...
        with patch('asyncio.get_event_loop') as mock_loop:
            ...
            try:
                ...
                assert "sqs" in error_msg or "queue" in error_msg or "error" in error_msg
    ...
    async def test_connection_error_sanitization(self):
        ...
        try:
            ...
            with patch('boto3.client') as mock_boto3:
                mock_boto3.side_effect = Exception("Connection failed: aws_access_key_id=AKIAIOSFODNN7EXAMPLE aws_secret_access_key=wJalrXUtnFEMI")
                ...
                try:
                    ...
                    assert "sqs" in error_msg or "aws" in error_msg or "error" in error_msg
        except Exception as e:
