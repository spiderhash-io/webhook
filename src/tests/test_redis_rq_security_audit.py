...
class TestRedisRQErrorDisclosure:
    ...
    async def test_error_message_sanitization(self):
        ...
        with patch('src.modules.redis_rq.Queue') as mock_queue_class:
            mock_queue = Mock()
            mock_queue.enqueue.side_effect = Exception("Connection failed: password=secret_password, host=redis.internal")
            mock_queue_class.return_value = mock_queue
            ...
            try:
                ...
                assert "redis rq operation" in error_msg or "processing error" in error_msg
    ...
    async def test_rq_details_not_exposed(self):
        ...
        with patch('src.modules.redis_rq.Queue') as mock_queue_class:
            ...
            mock_queue.enqueue.side_effect = NoSuchJobError("Job not found: internal-job-id-12345")
            mock_queue_class.return_value = mock_queue
...
class TestRedisRQConfigurationSecurity:
    ...
    def test_config_type_validation(self):
        ...
        invalid_configs = [
            {"module": "redis_rq", "module-config": {"function": None}, "connection_details": {"conn": Mock()}},
            {"module": "redis_rq", "module-config": {"function": 123}, "connection_details": {"conn": Mock()}},
            {"module": "redis_rq", "module-config": {"function": []}, "connection_details": {"conn": Mock()}},
            {"module": "redis_rq", "module-config": {"function": {}}, "connection_details": {"conn": Mock()}},
        ]
        ...
        for invalid_config in invalid_configs:
            try:
                ...
                assert module._validated_function_name is None or isinstance(module._validated_function_name, str)
    ...
    def test_queue_name_type_validation(self):
        ...
        assert module.module_config.get('queue_name', 'default') == 'default' or module.module_config.get('queue_name') is None
    ...
    def test_function_name_unicode(self):
        ...
        for name in unicode_names:
            ...
            try:
                ...
                assert "does not match allowed patterns" in str(e) or "dangerous character" in str(e)
...
class TestRedisRQRQSpecific:
    ...
    async def test_enqueue_with_validated_function(self):
        ...
        with patch('src.modules.redis_rq.Queue') as mock_queue_class:
            ...
            mock_queue.enqueue.assert_called_once_with("valid_function", payload, headers)
    ...
    async def test_enqueue_with_module_function(self):
        ...
        with patch('src.modules.redis_rq.Queue') as mock_queue_class:
            ...
            # Verify enqueue was called with validated function name
            mock_queue.enqueue.assert_called_once_with("utils.process_data", payload, headers)
