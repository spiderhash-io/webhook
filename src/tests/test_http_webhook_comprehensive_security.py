...
class TestAdvancedSSRFBypass:
    ...
    def test_hex_ip_encoding(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': 'http://0x7f000001/webhook'  # 127.0.0.1 in hex
            }
        }
    ...
    def test_missing_scheme(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': 'example.com/webhook'  # Missing scheme
            }
        }
        
        with pytest.raises(ValueError, match="scheme.*is not allowed|Invalid URL format"):
            HTTPWebhookModule(config)
    ...
    def test_fragment_in_url(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': 'http://example.com/webhook#fragment'
            }
        }
    ...
    def test_whitespace_in_url(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': '  http://example.com/webhook  '  # Whitespace
            }
        }
    ...
    def test_unicode_in_hostname(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': 'http://例え.テスト/webhook'  # Unicode
            }
        }
    ...
    def test_hostname_with_underscore(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': 'http://test_example.com/webhook'
            }
        }
...
class TestAdvancedHeaderInjection:
    ...
    def test_header_name_injection(self):
        ...
        for name in malicious_names:
            assert not module._validate_header_name(name), f"Should reject: {repr(name)}"
...
class TestURLValidationEdgeCases:
    ...
    def test_empty_hostname(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': 'http:///webhook'  # Empty hostname
            }
        }
    ...
    def test_ipv6_with_port(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': 'http://[2001:4860:4860::8888]:8080/webhook'
            }
        }
    ...
    def test_very_long_hostname(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': f'http://{long_hostname}/webhook'
            }
        }
    ...
    def test_hostname_with_many_subdomains(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': f'http://{many_subdomains}/webhook'
            }
        }
