...
class TestOAuth1NonceValidation:
    ...
    async def test_nonce_tracker_accepts_new_nonce(self, nonce_tracker):
        ...
        is_valid, message = await nonce_tracker.check_and_store_nonce(nonce, timestamp, timestamp_window)
        assert is_valid
    ...
    async def test_nonce_tracker_expires_old_nonces(self, nonce_tracker):
        ...
        is_valid, message = await nonce_tracker.check_and_store_nonce(nonce, old_timestamp, timestamp_window)
        assert is_valid
        ...
        is_valid, message = await nonce_tracker.check_and_store_nonce(expired_nonce, very_old_timestamp, timestamp_window)
        assert is_valid
        ...
        is_valid, message = await nonce_tracker.check_and_store_nonce(expired_nonce, int(time.time()), timestamp_window)
    ...
    async def test_nonce_tracker_stats(self, nonce_tracker):
        ...
        # Store a nonce
        await nonce_tracker.check_and_store_nonce("test_nonce_stats", timestamp, timestamp_window)
    ...
    async def test_nonce_tracker_cleanup_interval(self, nonce_tracker):
        ...
        # Store a nonce
        await nonce_tracker.check_and_store_nonce("test_nonce_cleanup", timestamp, timestamp_window)
