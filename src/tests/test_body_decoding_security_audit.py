...
class TestDetectEncodingReDoS:
    ...
    def test_redos_charset_regex_complex(self):
        ...
        malicious_content_type = "application/json; charset=" + ("'" * 100) + "utf-8" + ("'" * 100)
        ...
        assert result == "utf-8" or result is None  # May be None if validation rejects it
    ...
    def test_redos_charset_regex_many_semicolons(self):
        ...
        malicious_content_type = "application/json" + ("; param=value" * 100) + "; charset=utf-8"
    ...
    def test_redos_charset_regex_nested_quotes(self):
        ...
        malicious_content_type = 'application/json; charset="' + ("'" * 50) + 'utf-8' + ("'" * 50) + '"'
...
class TestEncodingInjection:
    ...
    def test_charset_injection_command_separators(self):
        ...
        for malicious_charset in malicious_charsets:
            ...
            assert result is None or ("|" not in result and "&" not in result and "`" not in result and "$" not in result and ";" not in result)
...
class TestBodyDecodingDoS:
    ...
    def test_large_content_type_header_dos(self):
        ...
        large_content_type = "application/json; " + "; ".join("param" + str(i) + "=value" + str(i) for i in range(1000)) + "; charset=utf-8"
