...
class TestEnvVarSubstitutionDeepRecursion:
    ...
    def test_deeply_nested_dict_recursion(self):
        ...
        try:
            ...
            pytest.fail("Deep recursion DoS vulnerability: stack overflow from deeply nested structure")
    ...
    def test_deeply_nested_list_recursion(self):
        ...
        try:
            ...
            pytest.fail("Deep recursion DoS vulnerability: stack overflow from deeply nested list")
