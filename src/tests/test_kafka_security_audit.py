...
class TestKafkaPartitionManipulation:
    ...
    async def test_partition_type_validation(self):
        ...
        config = {
            ...
            "topic": "webhook_events",
            "module-config": {
                "partition": "invalid"  # String instead of int
            }
        }
    ...
    async def test_partition_negative_value(self):
        ...
        config = {
            ...
            "topic": "webhook_events",
            "module-config": {
                "partition": -1  # Negative partition
            }
        }
    ...
    async def test_partition_large_value(self):
        ...
        config = {
            ...
            "topic": "webhook_events",
            "module-config": {
                "partition": 999999999  # Very large partition
            }
        }
...
class TestKafkaErrorDisclosure:
    ...
    async def test_error_message_sanitization(self):
        ...
        mock_producer.send.side_effect = Exception("Internal error with path: /etc/passwd")
    ...
    async def test_kafka_details_not_exposed(self):
        ...
        mock_producer.send.side_effect = KafkaError("Topic 'webhook_events' does not exist")
