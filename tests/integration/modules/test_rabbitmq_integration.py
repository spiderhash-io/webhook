...
class TestRabbitMQIntegration:
    ...
    async def test_rabbitmq_queue_creation(
        self, rabbitmq_channel, test_webhook_id: str
    ):
    ...
    async def test_rabbitmq_webhook_delivery(
        ...
        payload = {"test": "rabbitmq_integration", "timestamp": "2024-01-01T00:00:00Z"}
    ...
    @pytest.mark.asyncio
    async def test_rabbitmq_message_publish_consume(self, rabbitmq_channel):
