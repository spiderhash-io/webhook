...
class TestKafkaIntegration:
    ...
    async def test_kafka_topic_validation(self):
        ...
        valid_config = {
            ...
            "connection_details": {"bootstrap_servers": KAFKA_BOOTSTRAP_SERVERS},
        }
        ...
        with pytest.raises(
            ValueError, match="Invalid topic name format|dangerous|forbidden"
        ):
    ...
    async def test_kafka_message_with_key(self, kafka_consumer):
        ...
        config = {
            "module": "kafka",
            "topic": test_topic,
            "module-config": {"key": "test_key_123"},
            "connection_details": {"bootstrap_servers": KAFKA_BOOTSTRAP_SERVERS},
        }
    ...
    async def test_kafka_message_with_headers(self, kafka_consumer):
        ...
        test_headers = {"Authorization": "Bearer token123", "X-Custom": "custom_value"}
    ...
    async def test_kafka_connection_error_handling(self):
        ...
        config = {
            "module": "kafka",
            "topic": "test_topic",
            "connection_details": {"bootstrap_servers": "invalid_host:9092"},
        }
