    ...
    async def test_symlink_traversal_prevention(self, temp_base_dir):
        ...
        try:
            ...
            try:
                ...
                assert resolved.startswith(base_real) or os.path.commonpath([base_real, resolved]) == base_real
                ...
                assert any(keyword in error_str for keyword in ["escapes", "invalid", "validation", "path", "error"])
        finally:
