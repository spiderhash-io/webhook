...
from src.retry_handler import RetryHandler, DEFAULT_RETRYABLE_ERRORS, DEFAULT_NON_RETRYABLE_ERRORS
...
class TestRetryHandlerIntegration:
    ...
    async def test_retry_handler_error_classification(self, retry_handler):
        ...
        for error in non_retryable_errors:
            ...
            assert is_retryable is False, f"{type(error).__name__} should not be retryable"
