...
from tests.integration.test_config import (
    CLICKHOUSE_HOST, CLICKHOUSE_PORT, CLICKHOUSE_HTTP_URL,
...
class TestClickHouseAdvancedIntegration:
    ...
    @pytest.mark.asyncio
    async def test_include_headers_configuration(self, clickhouse_native_client: Client, cleanup_tables):
    ...
    @pytest.mark.asyncio
    async def test_include_timestamp_configuration(self, clickhouse_native_client: Client, cleanup_tables):
    ...
    @pytest.mark.asyncio
    async def test_table_auto_creation(self, clickhouse_native_client: Client, cleanup_tables):
    ...
    async def test_connection_error_handling(self):
        ...
        try:
            ...
            assert any(keyword in error_str for keyword in ["connection", "timeout", "resolve", "name resolution", "temporary failure"])
    ...
    @pytest.mark.asyncio
    async def test_module_with_headers_and_timestamp(self, clickhouse_native_client: Client, cleanup_tables):
