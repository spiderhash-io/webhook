...
class TestRedisRQIntegration:
    ...
    def test_redis_rq_enqueue_task(self, rq_connection):
        ...
        # Enqueue the task
        job = queue.enqueue(test_function, test_payload, test_headers)
    ...
    def test_redis_rq_function_name_validation(self):
        ...
        valid_config = {
            "module": "redis_rq",
            "module-config": {"function": "test_function"},
            "connection_details": {"conn": None},  # Will be set by config loader
        }
        ...
        invalid_config = {
            "module": "redis_rq",
            "module-config": {"function": "os.system"},
