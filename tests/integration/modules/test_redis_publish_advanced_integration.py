...
import json
import asyncio
from tests.integration.test_config import REDIS_URL, REDIS_HOST, REDIS_PORT, TEST_REDIS_PREFIX
...
class TestRedisPublishAdvancedIntegration:
    ...
    async def test_port_validation(self):
        ...
        invalid_configs = [
            {"host": REDIS_HOST, "port": 0, "channel": "test", "allowed_hosts": [REDIS_HOST]},
            {"host": REDIS_HOST, "port": 65536, "channel": "test", "allowed_hosts": [REDIS_HOST]},
            {"host": REDIS_HOST, "port": -1, "channel": "test", "allowed_hosts": [REDIS_HOST]},
        ]
    ...
    async def test_connection_error_handling(self):
        ...
        config = {
            ...
            "redis": {
                ...
                "port": 6379,
                "channel": "test",
                "allowed_hosts": ["invalid_host_that_does_not_exist"]  # Whitelist to pass host validation
            }
        }
