...
class TestHeaderAuth:
    ...
    async def test_header_auth_valid_key_default_header(self):
        ...
        config = {"header_auth": {"api_key": "secret_key_123"}}
    ...
    async def test_header_auth_valid_key_custom_header(self):
        ...
        config = {
            "header_auth": {"header_name": "X-Auth-Token", "api_key": "my_secret_token"}
        }
    ...
    async def test_header_auth_case_insensitive_header_name(self):
        ...
        config = {
            "header_auth": {"header_name": "X-API-Key", "api_key": "secret_key_123"}
        }
    ...
    async def test_header_auth_case_sensitive_true(self):
        ...
        config = {"header_auth": {"api_key": "SecretKey123", "case_sensitive": True}}
    ...
    async def test_header_auth_case_sensitive_false(self):
        ...
        config = {"header_auth": {"api_key": "SecretKey123", "case_sensitive": False}}
    ...
    async def test_header_auth_case_sensitive_default(self):
        ...
        config = {"header_auth": {"api_key": "SecretKey123"}}
    ...
    async def test_header_auth_missing_api_key_config(self):
        ...
        config = {"header_auth": {"header_name": "X-API-Key"}}
    ...
    async def test_header_auth_special_characters(self):
        ...
        config = {"header_auth": {"api_key": "key!@#$%^&*()_+-=[]{}|;:,.<>?"}}
    ...
    async def test_header_auth_unicode_characters(self):
        ...
        config = {"header_auth": {"api_key": "ключ_测试_🔑"}}
    ...
    async def test_header_auth_long_key(self):
        ...
        long_key = "a" * 1000
        config = {"header_auth": {"api_key": long_key}}
    ...
    async def test_header_auth_timing_attack_resistance(self):
        ...
        assert (
            time_diff_ratio < 1.0
        ), f"Timing attack check (first char) exceeded tolerance: {time_diff_ratio:.2%}"
        assert (
            time_diff_ratio2 < 1.0
        ), f"Timing attack check (last char) exceeded tolerance: {time_diff_ratio2:.2%}"
    ...
    async def test_header_auth_common_header_names(self):
        ...
        for header_name in common_names:
            config = {
                "header_auth": {"header_name": header_name, "api_key": "secret_key_123"}
            }
    ...
    async def test_header_auth_unicode_normalization(self):
        ...
        config = {"header_auth": {"api_key": "café"}}
