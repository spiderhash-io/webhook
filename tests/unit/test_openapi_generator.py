...
class TestOpenAPIGenerator:
    ...
    def test_generate_openapi_schema_basic(self):
        ...
        webhook_config = {"test_webhook": {"data_type": "json", "module": "log"}}
    ...
    def test_generate_openapi_schema_multiple_webhooks(self):
        ...
        webhook_config = {
            "webhook1": {"data_type": "json", "module": "log"},
            "webhook2": {"data_type": "json", "module": "save_to_disk"},
        }
    ...
    def test_extract_auth_schemes_header_auth(self):
        ...
        config = {"header_auth": {"header_name": "X-API-Key", "api_key": "key123"}}
    ...
    def test_extract_auth_schemes_query_auth(self):
        ...
        config = {"query_auth": {"parameter_name": "api_key", "api_key": "key123"}}
    ...
    def test_extract_auth_schemes_multiple(self):
        ...
        config = {
            ...
            "hmac": {"secret": "secret", "header": "X-HMAC-Signature"},
        }
    ...
    def test_extract_security_requirements_multiple(self):
        ...
        config = {"authorization": "Bearer token", "hmac": {"secret": "secret"}}
    ...
    def test_extract_security_info_hmac(self):
        ...
        config = {"hmac": {"algorithm": "sha256", "header": "X-HMAC-Signature"}}
    ...
    def test_extract_security_info_recaptcha(self):
        ...
        config = {"recaptcha": {"version": "v3", "min_score": 0.5}}
    ...
    def test_extract_security_info_credential_cleanup(self):
        ...
        config = {"credential_cleanup": {"enabled": True, "mode": "mask"}}
    ...
    def test_generate_openapi_schema_complex(self):
        ...
        webhook_config = {
            "complex_webhook": {
                ...
                "credential_cleanup": {"enabled": True, "mode": "mask"},
            }
        }
