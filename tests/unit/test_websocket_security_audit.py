    ...
    async def test_error_message_sanitization(self):
        ...
        with patch("websockets.connect") as mock_connect:
            mock_connect.side_effect = Exception(
                "Connection failed: password=secret_password, host=ws.internal"
            )
    ...
    async def test_websocket_details_not_exposed(self):
        ...
        with patch("websockets.connect") as mock_connect:
            ...
            mock_connect.side_effect = websockets.exceptions.WebSocketException(
                "Internal error: connection refused at ws://internal:8080"
            )
...
class TestWebSocketMessageSerialization:
    ...
    async def test_message_structure_raw_format(self):
        ...
        config = {
            "module": "websocket",
            "module-config": {"url": "ws://example.com/ws", "format": "raw"},
        }
...
class TestWebSocketHeadersHandling:
    ...
    async def test_headers_with_special_characters(self):
        ...
        config = {
            "module": "websocket",
            "module-config": {"url": "ws://example.com/ws", "include_headers": True},
        }
    ...
    def test_config_type_validation(self):
        ...
        for invalid_config in invalid_configs:
            try:
                ...
                assert module._validated_url is None or isinstance(
                    module._validated_url, str
                )
...
class TestWebSocketSpecific:
    ...
    async def test_retry_mechanism(self):
        ...
        config = {
            "module": "websocket",
            "module-config": {"url": "ws://example.com/ws", "max_retries": 3},
        }
    ...
    async def test_timeout_configuration(self):
        ...
        config = {
            "module": "websocket",
            "module-config": {"url": "ws://example.com/ws", "timeout": 5},
        }
    ...
    async def test_wait_for_response(self):
        ...
        config = {
            "module": "websocket",
            "module-config": {"url": "ws://example.com/ws", "wait_for_response": True},
        }
    ...
    def test_allowed_hosts_empty_list(self):
        ...
        try:
            ...
            assert "not in the allowed hosts whitelist" in str(
                e
            ) or "whitelist is empty" in str(e)
