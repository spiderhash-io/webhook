...
async def test_jwt_valid_issuer():
    ...
    secret = "jwt_secret_key"
    issuer = "my-app"
    config = {"jwt": {"secret": secret, "algorithm": "HS256", "issuer": issuer}}
...
async def test_jwt_invalid_issuer():
    ...
    secret = "jwt_secret_key"
    config = {
        "jwt": {"secret": secret, "algorithm": "HS256", "issuer": "expected-issuer"}
    }
...
async def test_jwt_valid_audience():
    ...
    secret = "jwt_secret_key"
    audience = "my-api"
    config = {"jwt": {"secret": secret, "algorithm": "HS256", "audience": audience}}
...
async def test_jwt_invalid_audience():
    ...
    secret = "jwt_secret_key"
    config = {
        "jwt": {"secret": secret, "algorithm": "HS256", "audience": "expected-audience"}
    }
...
async def test_jwt_missing_claims_when_required():
    ...
    secret = "jwt_secret_key"
    config = {"jwt": {"secret": secret, "issuer": "required-issuer"}}
...
async def test_jwt_future_expiration():
    ...
    secret = "jwt_secret_key"
    config = {"jwt": {"secret": secret, "verify_exp": True}}
