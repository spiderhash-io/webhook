...
class TestHTTPSSRFPrevention:
    ...
    def test_localhost_blocked(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "http://localhost:8080/webhook"},
        }
    ...
    def test_127_0_0_1_blocked(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "http://127.0.0.1:8080/webhook"},
        }
    ...
    def test_private_ip_ranges_blocked(self):
        ...
        for ip in private_ips:
            config = {
                "module": "http_webhook",
                "module-config": {"url": f"http://{ip}:8080/webhook"},
            }
    ...
    def test_link_local_blocked(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "http://169.254.169.254/latest/meta-data/"},
        }
    ...
    def test_file_scheme_blocked(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "file:///etc/passwd"},
        }
    ...
    def test_gopher_scheme_blocked(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "gopher://example.com"},
        }
    ...
    def test_https_allowed(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "https://example.com/webhook"},
        }
    ...
    def test_public_ip_allowed(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "http://8.8.8.8/webhook"},
        }
    ...
    def test_multicast_blocked(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "http://224.0.0.1/webhook"},
        }
    ...
    def test_reserved_ip_blocked(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "http://0.0.0.0/webhook"},
        }
    ...
    def test_missing_url_allowed(self):
        ...
        config = {"module": "http_webhook", "module-config": {}}
    ...
    def test_invalid_url_format_rejected(self):
        ...
        config = {"module": "http_webhook", "module-config": {"url": "not a valid url"}}
    ...
    def test_url_with_path_allowed(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "https://example.com/api/v1/webhook?param=value"},
        }
    ...
    def test_public_hostname_allowed(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "https://api.github.com/webhooks"},
        }
    ...
    def test_ipv6_public_allowed(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "http://[2001:4860:4860::8888]/webhook"},
        }
    ...
    def test_ipv6_private_blocked(self):
        ...
        config = {
            "module": "http_webhook",
            "module-config": {"url": "http://[fc00::1]/webhook"},
        }
