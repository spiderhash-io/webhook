...
class TestCredentialCleaner:
    ...
    def test_nested_structures(self):
        ...
        data = {
            "user": {
                "name": "John",
                "password": "secret",
                "profile": {"api_key": "key123", "email": "john@example.com"},
            },
            "tokens": [
    ...
    def test_clean_query_params(self):
        ...
        params = {"page": "1", "api_key": "key123", "token": "token456", "limit": "10"}
    ...
    def test_deep_nesting(self):
        ...
        data = {
            "level1": {
                "level2": {
                    "level3": {
                        "level4": {"secret": "deep_secret", "data": "normal_data"}
                    }
                }
            }
        }
        ...
        assert (
            cleaned["level1"]["level2"]["level3"]["level4"]["secret"]
            == "***REDACTED***"
        )
...
class TestCredentialCleanupIntegration:
    ...
    async def test_webhook_cleanup_enabled(self):
        ...
        request.body = AsyncMock(
            return_value=b'{"username": "user", "password": "secret"}'
        )
        ...
        with patch("src.webhook.ModuleRegistry.get") as mock_get:
            ...
            handler = WebhookHandler(
                "test_webhook", configs, {}, request, pool_registry=None
            )
    ...
    async def test_clickhouse_analytics_cleanup(self):
        ...
        payload = {"username": "user", "password": "secret123", "api_key": "key456"}
        headers = {
    ...
    def test_cleanup_preserves_original(self):
        ...
        original_data = {"username": "user", "password": "secret"}
