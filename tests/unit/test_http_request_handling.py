...
class TestURLEncodingHandling:
    ...
    def test_url_with_encoded_query_params(self):
        ...
        assert 'param1=value%20with%20spaces' in module._validated_url or 'param1=value with spaces' in module._validated_url
    ...
    def test_url_with_special_characters(self):
        ...
        config = {
            'module': 'http_webhook',
            'module-config': {
                'url': 'http://example.com/webhook?key=value&other=test'
            }
        }
        module = HTTPWebhookModule(config)
...
class TestRequestTimeoutPropagation:
    ...
    async def test_timeout_config_respected(self):
        ...
        with patch('httpx.AsyncClient') as mock_client:
            ...
            assert 'timeout' in call_kwargs or mock_client.call_args[0]  # timeout can be positional or keyword
