...
class TestConfigJSONParsingDoS:
    ...
    def test_large_json_config(self):
        ...
        large_config = {"webhook": {"data": "x" * 1000000}}  # 1MB string
    ...
    def test_circular_reference_in_config(self):
        ...
        config = {
            "webhook1": {"connection": "conn1"},
            "webhook2": {"connection": "conn2"},
        }
...
class TestConfigInjection:
    ...
    async def test_connection_type_validation(self):
        ...
        webhook_config = {
            "test_webhook": {"module": "redis_rq", "connection": "invalid_conn"}
        }
    ...
    async def test_missing_connection_handling(self):
        ...
        webhook_config = {
            "test_webhook": {"module": "redis_rq", "connection": "nonexistent_conn"}
        }
    ...
    async def test_connection_name_injection(self):
        ...
        connection_config = {
            "../../etc/passwd": {"type": "redis-rq", "host": "8.8.8.8", "port": 6379}
        }
...
class TestInjectConnectionDetailsSecurity:
    ...
    async def test_missing_host_handling(self):
        ...
        webhook_config = {
            "test_webhook": {"module": "redis_rq", "connection": "redis_test"}
        }
    ...
    async def test_multiple_webhooks_same_connection(self):
        ...
        webhook_config = {
            "webhook1": {"module": "redis_rq", "connection": "shared_conn"},
            "webhook2": {"module": "redis_rq", "connection": "shared_conn"},
        }

        connection_config = {
            "shared_conn": {"type": "redis-rq", "host": "8.8.8.8", "port": 6379}
        }
...
class TestConfigLargeDoS:
    ...
    def test_large_number_of_webhooks(self):
        ...
        large_config = {}
        for i in range(1000):
            large_config[f"webhook_{i}"] = {"module": "log", "data_type": "json"}
