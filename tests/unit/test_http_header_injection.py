...
class TestHTTPHeaderInjection:
    ...
    def test_carriage_return_injection_rejected(self):
        ...
        headers = {
            "X-Injected": "value\rX-Injected-Header: malicious"
        }
    ...
    def test_header_name_validation(self):
        ...
        for name in invalid_names:
            assert not module._validate_header_name(name), f"Should reject invalid header name: {repr(name)}"
    ...
    def test_valid_header_names(self):
        ...
        for name in valid_names:
            assert module._validate_header_name(name), f"Should accept valid header name: {name}"
    ...
    def test_custom_headers_sanitized(self):
        ...
        assert "X-Invalid" not in sanitized_custom  # Should be filtered due to injection attempt
