...
class TestTempDirectorySecurity:
    ...
    def test_temp_directories_allowed(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            assert os.path.commonpath([os.path.realpath(tmpdir), validated_path]) == os.path.realpath(tmpdir)
    ...
    def test_temp_dir_exception_documented(self):
        ...
        temp_dirs = ['/var/tmp/', '/var/folders/', '/private/var/tmp/', '/private/var/folders/', '/tmp/']
