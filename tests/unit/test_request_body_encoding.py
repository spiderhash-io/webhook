...
class TestRequestBodyEncoding:
    ...
    def test_detect_encoding_from_content_type(self):
        ...
        # UTF-8 encoding
        assert detect_encoding_from_content_type("application/json; charset=utf-8") == "utf-8"
        assert detect_encoding_from_content_type("application/json; charset=UTF-8") == "utf-8"
        assert detect_encoding_from_content_type("application/json; charset='utf-8'") == "utf-8"
        assert detect_encoding_from_content_type('application/json; charset="utf-8"') == "utf-8"
        
        # Other encodings
        assert detect_encoding_from_content_type("text/plain; charset=iso-8859-1") == "iso-8859-1"
        assert detect_encoding_from_content_type("application/json; charset=latin-1") == "latin-1"
        assert detect_encoding_from_content_type("application/json; charset=utf-16") == "utf-16"
    ...
    def test_safe_decode_body_fallback_encodings(self):
        ...
        assert encoding in ["latin-1", "iso-8859-1", "cp1252", "utf-8", "utf-16", "utf-16le", "utf-16be"]
